  ...
  <div v-if="product" class="relative w-full p-5 my-2 md:my-0 rounded-lg">
    <div class="absolute top-5 right-5 flex items-center m-5 z-40">
      <Transition name="bounce">
        <button
          v-if="onCart"
          class="text-red-500 hover:text-red-600 mr-1 ease-in-out duration-200"
          type="button"
      ...
      <Transition name="bounce">
        <button
          v-if="onLiked"
          class="text-red-500 hover:text-red-600 ml-1 ease-in-out duration-200"
          type="button"
    ...
    <div class="bg-white rounded-lg w-full h-full relative overflow-hidden">
      <div class="w-full">
        <div
          ...
          @click="$router.push('/products/' + product.uuid)"
        ></div>
      </div>
